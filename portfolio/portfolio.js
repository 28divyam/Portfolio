...
let swiperProjects = new Swiper(".projects_container", {
    ...
    pagination: {
        el: ".swiper-pagination", // Corrected selector
...
const contactProject = document.getElementById('contact_project');
...
const sendEmail = (e) => {
    ...
    if (contactName.value === '' || contactEmail.value === '' || contactProject.value === '') {
        ...
        emailjs.sendForm('service_gour6ek', 'template_7yhozp1', '#contact-form', 'gtlpdtmuolaz79QB3')
            .then(() => {
...
const scrollUp = () => {
    ...
    if (scrollUpButton) {
        ...
        if (window.scrollY >= 350) {
            ...
            console.log('Added show-scroll class');
        } else {
            scrollUpButton.classList.remove('show-scroll');
            console.log('Removed show-scroll class');
        }
    } else {
        console.log('Scroll-up button not found');
    }
};
